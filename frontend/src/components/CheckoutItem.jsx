...
const CheckoutItem =({imagen, titulo, unidad, cantidad, precio})=>{
    return(
      ...
      <div className="flex-1">
        ...
        <p className="text-sm text-[#b14158] font-semibold">{unidad}</p>
      </div>
      
      <div className="flex items-center justify-center w-50 text-center">
        <span className="text-[#b14158] text-xl font-bold">{cantidad}</span>
      </div>
