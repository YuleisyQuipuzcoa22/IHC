...
const Pago = () => {
  ...
  return (
    <div className="pt-15 pb-20 pl-25 pr-25  flex flex-col gap-6 ">
      <div className=" flex flex-col lg:flex-row gap-10">
        <div className="lg:w-3/5 bg-[#ECE0E0] p-6 rounded-lg shadow overflow-y-auto max-h-[600px] ">
          ...
          <div className="bg-[#E8464D] p-4 rounded-lg  flex items-center gap-4 mb-4">
            ...
            <div className="w-26 text-left font-bold">
        ...
        <div className="lg:w-2/5 bg-[#ECE0E0] p-6 rounded-lg shadow ">
          ...
          <PaymentMethods getCheckoutForm={() => checkoutFormRef.current?.form}/>
        </div>
      </div>
    </div>
  );
